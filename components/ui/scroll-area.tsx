...
>(({ className, orientation = "vertical", ...props }, ref) => (
  <ScrollAreaPrimitive.ScrollAreaScrollbar
    ...
    {...props}
  >
    <ScrollAreaPrimitive.ScrollAreaThumb className="relative flex-1 rounded-full bg-slate-400/60 hover:bg-slate-400/80 dark:bg-slate-500/60 dark:hover:bg-slate-500/80 transition-colors" />
  </ScrollAreaPrimitive.ScrollAreaScrollbar>
));
