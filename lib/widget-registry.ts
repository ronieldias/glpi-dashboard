...
import { WidgetBacklogByAge } from "@/components/dashboard/widgets/widget-backlog-by-age";
...
export const widgetCatalog: WidgetDefinition[] = [
  // Ticket KPIs
  {
    ...
    maxW: 12,
    maxH: 8,
    component: KPITicketsOpen,
  },
  {
    id: "kpi-tickets-closed",
  ...
  // Project KPIs
  {
    ...
    maxW: 12,
    maxH: 8,
    component: KPIProjectsActive,
  },
  {
    id: "kpi-projects-done",
    title: "Concluídos no Ano",
    category: "projects",
    defaultW: 1,
    defaultH: 1,
    minW: 1,
  ...
  // Tickets charts
  {
    ...
    maxW: 12,
    maxH: 8,
    component: WidgetTicketsByStatus,
  },
  {
    ...
    maxW: 12,
    maxH: 8,
    component: WidgetTicketsByPriority,
  },
  {
    id: "tickets-trend",
    ...
    maxW: 12,
    maxH: 8,
    component: WidgetTicketsTrend,
  },
  {
    id: "tickets-by-technician",
    title: "Ranking Técnicos",
    category: "tickets",
    defaultW: 3,
    defaultH: 3,
    minW: 2,
    ...
    maxW: 12,
    maxH: 8,
    component: WidgetTicketsByTechnician,
  },
  {
    ...
    maxW: 12,
    maxH: 8,
    component: WidgetTicketsByCategory,
  },
  {
    id: "tickets-sla",
    title: "Incidentes vs Requisições",
    category: "tickets",
    defaultW: 3,
    defaultH: 3,
    minW: 2,
  ...
  // Projects charts
  {
    ...
    maxW: 12,
    maxH: 8,
    component: WidgetProjectsByStatus,
  },
  {
    ...
    maxW: 12,
    maxH: 8,
    component: WidgetProjectProgress,
  },
  {
    id: "projects-tasks-summary",
    ...
    maxW: 12,
    maxH: 8,
    component: WidgetProjectTasksSummary,
  },
  {
    ...
    maxW: 12,
    maxH: 8,
    component: WidgetProjectTimeline,
  },
  {
    id: "projects-table",
